...
#all players
appURL <- "http://www.basketball-reference.com/leagues/NBA_2019_per_game.html"
...
bb_raw <- read.delim("20171231_players.csv", stringsAsFactors = FALSE)
...
#setwd("/run/media/atoerok/Data/dominateR")
save.image(file = "dominateR2019.RData")
